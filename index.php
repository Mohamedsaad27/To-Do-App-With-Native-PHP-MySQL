...
$view_task_data = "SELECT * FROM `tasks` ORDER BY `id` desc";
                ...
                <table class="table table-bordered">
                    ...
                    while($row = mysqli_fetch_assoc($result)):?> 
                            <tr>
                                ...
                                <td>
                                    <a  href="handlers/deletetask.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
